...
5:05 to 5:15 ---> Break
5:15 to 6:00 ---> PolyMorphism
6:00 to 6:20 ---> BreakOut
Advanced Xpath:
1)parent to child:
syn:basic relative xpath of the parent/tagname of child
eg)//p[@class='top']/input
2)Grandparent to grandchild:
syn:xpath for the Grandparent//tagname of the grand child
eg)(//form[@id='login']//input)[1]
3)child to parent:
syn:xpath of the child/parent::parent tagname
eg)//input[@id='password']/parent::p
4)grandchild to grandparent:
syn: xpath for the grandchild/ancestor::tagname of the grandparent
eg)//input[@class='decorativeSubmit']/ancestor::form
5)elder cousin to younger cousin:
xpath for eldercousin/following::younger cousin tagname
eg)(//span[text()='Company Name']/following::input)[1]
6)Youngercousin to eldercousin:
syn:xpath for youngercousin/preceding::tagname of eldercousin
7)eldersibling to youngersibling
syn:xpath of eldersibling/following-sibling::younger sibling tagname
//label[text()='Username']/following-sibling::input
8)youngersibling to eldersibling:
syn:xpath of younger sibling/preceding-sibling::tagname of elder sibling

Selenium wait:
implicit wait:
-global wait
-it will not wait for the entire duration which is specified,once it locate the elemnt it moves to the next line of code.
-after reaching the max.limit ,if the elemnt is not found then it throws no such element exception.
