3:00 to 3:10 --->Mentor Introduction
3:10 to 4:00 ---> CoreJavaIntroduction
4.00 to 4:15 ---> Breakout
4:15 to 4:30 ---> Break
4:30 to 5:00 ---> DataTypes and Variables
5:00 to 5:15 ---> Breakut
5:15 to 6:00 ---> Operators & Conditional Statements
6:00 to 6:15 ---> Recap
...
-WholeNumbers:
 byte-8 bit of data
 short-16bit(5digits)
 int--32 bit(1 t0 9 digits)
 long-64 bit(15 digits)

 -To store decimal digits
